...
export interface ApiAboutPageAboutPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    seoContent: Attribute.Component<'seo.seo-meta'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    socialIcons: Attribute.Component<'elements.social-icon', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    slider: Attribute.Component<'blocks.text-slider'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationNavigation extends Schema.SingleType {
  ...
  attributes: {
    navItems: Attribute.Component<'elements.nav-item', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subServices: Attribute.RichText &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    workCategories: Attribute.Relation<
      'api::work.work',
      'manyToMany',
...
export interface ApiWorkCategoryWorkCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::work-category.work-category', 'title'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
